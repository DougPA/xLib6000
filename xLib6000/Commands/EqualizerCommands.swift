...
extension Equalizer {
  ...
  @objc dynamic public var level63Hz: Int {
    ...
    set { if _level63Hz != newValue { _level63Hz = newValue ; eqCmd( .level63Hz, newValue) } } }
  
  @objc dynamic public var level125Hz: Int {
    get { return _level125Hz }
    set { if _level125Hz != newValue { _level125Hz = newValue ; eqCmd( .level125Hz, newValue) } } }
  
  @objc dynamic public var level250Hz: Int {
    get { return _level250Hz }
    set { if _level250Hz != newValue { _level250Hz = newValue ; eqCmd( .level250Hz, newValue) } } }
  
  @objc dynamic public var level500Hz: Int {
    get { return _level500Hz }
    set { if _level500Hz != newValue { _level500Hz = newValue ; eqCmd( .level500Hz, newValue) } } }
  
  @objc dynamic public var level1000Hz: Int {
    get { return _level1000Hz }
    set { if _level1000Hz != newValue { _level1000Hz = newValue ; eqCmd( .level1000Hz, newValue) } } }
  
  @objc dynamic public var level2000Hz: Int {
    get { return _level2000Hz }
    set { if _level2000Hz != newValue { _level2000Hz = newValue ; eqCmd( .level2000Hz, newValue) } } }
  
  @objc dynamic public var level4000Hz: Int {
    get { return _level4000Hz }
    set { if _level4000Hz != newValue { _level4000Hz = newValue ; eqCmd( .level4000Hz, newValue) } } }
  
  @objc dynamic public var level8000Hz: Int {
    get { return _level8000Hz }
    set { if _level8000Hz != newValue { _level8000Hz = newValue ; eqCmd( .level8000Hz, newValue) } } }
}
